...
/*
 *   Reference variables (arrays and string for now)
 */
public class References {
    ...
    void program() {
        ...
        out.println(arr1 == arr2);  // No
        arr3 = arr1;
        out.println(arr1 == arr3);  // Yes, references same object

        out.println(arr1[0] == arr2[0]);  // No!
        out.println(arr1[0] == arr3[0]);  // Yes!
        ...
        out.println(s1.equals("Hello world"));  // True, same chars (values)
